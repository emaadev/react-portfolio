        ...
        >
            ...
            >
                ...
                <motion.div className="pl-[25px] -mt-[15px]">
                    ...
                    <motion.img src={skills[skillSelector].value[0].src} alt="Test" className="w-[40px] mb-[10px]" />
                    <motion.h5 className={`${styles.heading5} xs:text-[20px] xs:leading-[16px]`}>
                        {skills[skillSelector].value[0].title}
                    </motion.h5>
                    <motion.p className={`${styles.paragraph} text-white text-[15px] text-left`}>
