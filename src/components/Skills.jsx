...
const Skills = () => {
  ...
  return (
    <section
      id="skills"
      className={`${styles.flexCenter} flex-col pt-[100px] mb-[100px]`}
    >
      ...
      <div
        className={`flex justify-center items-center md:items-start flex-col md:flex-row`}
      >
        <div className="mt-[50px] md:mt-[80px] md:pl-[30px]">
          <h4
            className={`${styles.heading5} text-[23px] sm:text-[25px] sm:leading-[30px]`}
          >
          ...
          >
            ...
            projects in Software Development on the client side (Front-End).
            <br />
            <br />
            I mainly develop JavaScript-based projects with ReactJS and NodeJS.
            <br />
            Always with an open mind to continue learning the technologies that
            are needed.
            <br />
            <br />
            Visit my{" "}
        ...
        <div className="">
          ...
          <CloudText
            className={"cloudText font-poppins font-semibold z-[1] relative"}
          />
        </div>
      </div>
      ...
      <div>
            ...
            >
              {skill.value.map((content) => (
                <motion.div key={content.title}>
                  ...
                  />
                  <motion.h5 className={`${styles.heading5} xs:leading-[16px]`}>
                    {content.title}
                  </motion.h5>
        ...
        <AnimatePresence>
          {selectedId && (
            <InfoSkills selectedId={selectedId} setSelectedId={setSelectedId} />
          )}
        </AnimatePresence>
      </div>
    </section>
